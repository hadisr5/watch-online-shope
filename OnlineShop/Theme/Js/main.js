...
$('[data-countdown]:not(.pro-countdown1)').each(function() {
	...
	$this.countdown(finalDate, function(event) {
		$this.html(event.strftime('<div class="single-count"><span>%D</span>روز</div><div class="single-count"><span>%H</span>ساعت</div><div class="single-count"><span>%M</span>دقیقه</div><div class="single-count"><span>%S</span>ثانیه</div>'));
	});
}); 
/*----------------------------------- 
