...
var KTTagifyDemos = {
    init: function () {
        ...
        !(function () {
            ...
            document.getElementById("kt_tagify_1_remove").addEventListener("click", a.removeAllTags.bind(a)),
                a
                    .on("add", function i(o) {
            ...
            (e = document.getElementById("kt_tagify_1_1")),
                ...
                var e = document.getElementById("kt_tagify_4"),
                    a = new Tagify(e, {
                        ...
                        transformTag: function (e) {
                            (e.class = "tagify__tag tagify__tag--" + ["success", "primary", "danger", "success", "warning", "dark", "primary", "info"][KTUtil.getRandomInt(0, 7)]), "shit" == e.value.toLowerCase() && (e.value = "sâœ²âœ²t");
                        },
                        dropdown: { enabled: 3 },
                    });
                a.on("add", function (e) {
            ...
            new Tagify(a, {
                ...
                keepInvalidTags: !0,
                whitelist: [
                    { value: "Chris Muller", email: "chris.muller@wix.com", initials: "", initialsState: "", pic: "./assets/media/users/100_11.jpg", class: "tagify__tag--primary" },
                    { value: "Nick Bold", email: "nick.seo@gmail.com", initials: "SS", initialsState: "warning", pic: "" },
                    { value: "Alon Silko", email: "alon@keenthemes.com", initials: "", initialsState: "", pic: "./assets/media/users/100_6.jpg" },
                    { value: "Sam Seanic", email: "sam.senic@loop.com", initials: "", initialsState: "", pic: "./assets/media/users/100_8.jpg" },
                    { value: "Sara Loran", email: "sara.loran@tilda.com", initials: "", initialsState: "", pic: "./assets/media/users/100_9.jpg" },
                    { value: "Eric Davok", email: "davok@mix.com", initials: "", initialsState: "", pic: "./assets/media/users/100_13.jpg" },
                    { value: "Sam Seanic", email: "sam.senic@loop.com", initials: "", initialsState: "", pic: "./assets/media/users/100_13.jpg" },
                    { value: "Lina Nilson", email: "lina.nilson@loop.com", initials: "LN", initialsState: "danger", pic: "./assets/media/users/100_15.jpg" },
                ],
                templates: {
                    dropdownItem: function (e) {
                        try {
                            var a = "";
                            return (
                                (a += '<div class="tagify__dropdown__item">'),
                                (a += '   <div class="d-flex align-items-center">'),
                                (a += '       <span class="symbol sumbol-' + (e.initialsState ? e.initialsState : "") + ' mr-2">'),
                                (a += '           <span class="symbol-label" style="background-image: url(\'' + (e.pic ? e.pic : "") + "')\">" + (e.initials ? e.initials : "") + "</span>"),
                                (a += "       </span>"),
                                (a += '       <div class="d-flex flex-column">'),
                                (a += '           <a href="#" class="text-dark-75 text-hover-primary font-weight-bold">' + (e.value ? e.value : "") + "</a>"),
                                (a += '           <span class="text-muted font-weight-bold">' + (e.email ? e.email : "") + "</span>"),
                                (a += "       </div>"),
                                (a += "   </div>"),
                                (a += "</div>")
                            );
